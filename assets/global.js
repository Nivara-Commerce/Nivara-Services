  ...
  $.ajax({
    ...
    success: function(res){
      ...
      setTimeout(function(){
        ...
        $('<div id="cart-notification-product" class="cart-notification-product"><div class="cart-notification-product__image global-media-settings"><img src="'+res.items[0].image+'" alt="" width="70" height="47" loading="lazy"></div><div><h3 class="cart-notification-product__name h4">Copy of Nivara</h3><dl></dl></div></div>').insertAfter('.cart-notification__header');
